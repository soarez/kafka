...
object RequestConvertToJson {
  def request(request: AbstractRequest): JsonNode = {
    request match {
      ...
      case req: AssignReplicasToDirectoriesRequest => AssignReplicasToDirectoriesRequestDataJsonConverter.write(req.data, request.version)
  ...
  def response(response: AbstractResponse, version: Short): JsonNode = {
    response match {
      ...
      case res: AssignReplicasToDirectoriesResponse => AssignReplicasToDirectoriesResponseDataJsonConverter.write(res.data, version)

...
public enum ApiKeys {
    ...
    ASSIGN_REPLICAS_TO_DIRECTORIES(ApiMessageType.ASSIGN_REPLICAS_TO_DIRECTORIES, true, true),
    LOG_DIRECTORIES_OFFLINE(ApiMessageType.LOG_DIRECTORIES_OFFLINE, true, true);
